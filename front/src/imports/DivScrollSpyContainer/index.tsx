...
function H3TedLassoseason4Cardiheadline() {
  const d = useMobileHome();
  return (
    <div className="h-[51px] relative shrink-0 w-[362px]" data-name="h3#TedLassoseason4Cardiheadline">
      <div className="[word-break:break-word] flex flex-col font-['IRANSansX:Bold',sans-serif] min-h-[51px] justify-start leading-[0] relative not-italic text-[16.7px] text-right text-white top-0 w-[328px]">
